...
5. categories: 从以下两类分类中选择最相关的1-3个（可以选多个）：
   a) 业务方向分类：根据文章内容所属行业，从以下分类中选择（每条 insight 可以有多个业务分类）：
{{category_prompt}}
   b) 主体分类：中央部委、地方政府、国有企业、外国公司、私营企业、研究机构。
   规则：必须至少包含一个业务方向分类；可再搭配至多一个主体分类，按核心事件主体的性质判断（中央级政策发布方/监管机构如国务院、国家发改委、国家能源局等→中央部委，省/市/县级政府及其部门→地方政府，央企/地方国企→国有企业，外资/跨国公司→外国公司，民营企业→私营企业，高校/科研院所→研究机构），无法判断主体性质则不加。不要返回上述两类以外的分类。
