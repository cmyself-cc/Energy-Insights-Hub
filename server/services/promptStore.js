...
5. categories: 从以下两类分类中选择最相关的1-3个：
   ...
   b) 主体分类：政府、国有企业、外国公司、私营企业、研究机构。
   规则：必须至少包含一个业务方向分类（即 {{category_list}} 中的一项，按文章内容所属行业选择）；可再搭配至多一个主体分类，按核心事件主体的性质判断（政策发布方/监管机构→政府，央企/地方国企→国有企业，外资/跨国公司→外国公司，民营企业→私营企业，高校/科研院所→研究机构），无法判断主体性质则不加。不要返回上述两类以外的分类。
