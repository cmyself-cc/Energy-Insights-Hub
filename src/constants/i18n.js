export const i18n = {
  en: {
    ...
    contentFilters: {
      ...
      compositeRules: "Composite Rules",
      ruleName: "Rule Name",
      ruleNamePlaceholder: "Rule name (optional)",
      mustInclude: "Must Include",
      mustIncludePlaceholder: "Keywords separated by commas",
      mustExclude: "Must Exclude",
      mustExcludePlaceholder: "Keywords separated by commas",
      priority: "Priority",
  ...
  zh: {
    ...
    contentFilters: {
      ...
      mustInclude: "必须包含",
      mustIncludePlaceholder: "逗号分隔的关键词",
      mustExclude: "必须排除",
      mustExcludePlaceholder: "逗号分隔的关键词",
      priority: "优先级",
      ruleAdded: "规则已添加",
      unnamedRule: "未命名规则",
      include: "包含",
