export const i18n = {
  en: {
    ...
    trackerSettings: {
      ...
      wechatMcpPerFeedLimit: "WeChat MCP articles per account",
      ...
      scheduleTitle: "Scheduled Tracking",
      scheduleDesc: "Control whether the tracker runs automatically on a schedule.",
      scheduleToggle: "Enable scheduled tracking",
      ...
      sourcesDesc: "Select which source types the tracker should crawl. Unchecked types are skipped.",
      sourceTypes: {
        website: "Website",
        rss: "RSS",
        wechat_mcp: "WeChat MCP"
      },
      save: "Save",
  ...
  zh: {
    ...
    trackerSettings: {
      ...
      wechatMcpPerFeedLimit: "微信公众号每号抓取上限",
      ...
      scheduleTitle: "定时跟踪",
      scheduleDesc: "控制跟踪器是否按计划自动运行。",
      scheduleToggle: "启用定时跟踪",
      frequencyLabel: "频次",
      daily: "每天",
      weekly: "每周",
      timeLabel: "时间点",
      ...
      sourcesTitle: "监控信源",
      sourcesDesc: "选择需要跟踪抓取的信源类型，未勾选的信源类型将被跳过。",
      sourceTypes: {
        website: "网站",
        rss: "RSS",
        wechat_mcp: "微信MCP"
