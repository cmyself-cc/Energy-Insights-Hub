...
export const backendApi = {
  ...
  generateReport: (templateId, insightIds, resolutions, purpose, audience) => request("/reports/generate", { method: "POST", body: JSON.stringify({ templateId, insightIds, resolutions, purpose, audience }) }),
